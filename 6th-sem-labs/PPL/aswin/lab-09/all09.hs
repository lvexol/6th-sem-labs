Nested Decision Making with if-else
...
Using match with Complex Cases
...
Pattern Matching in Loops with while let
...
Tuple Manipulation in a Real-World Scenario
...
fn apply_salary_hike(employee: (u32, &str, u32)) -> (u32, &str, u32) {
 ...
 Vector (List) Operations with Iterators
